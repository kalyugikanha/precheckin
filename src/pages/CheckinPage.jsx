        ...
        <div className="property-details-panel">
          ...
          <div className="property-info-box">
            ...
            <div className="address-container">
              <svg className="info-icon" xmlns="http://www.w3.org/2000/svg" width="24" height="24"><path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0 1 18 0z" /><circle cx="12" cy="10" r="3" /></svg>
              <p className="address-text">{trip.address}</p>
              <svg className="share-icon" onClick={handleCopyMapUrl} xmlns="http://www.w3.org/2000/svg" width="24" height="24"><circle cx="18" cy="5" r="3" /><circle cx="6" cy="12" r="3" /><circle cx="18" cy="19" r="3" /><line x1="8.59" y1="13.51" x2="15.42" y2="17.49" /><line x1="15.41" y1="6.51" x2="8.59" y2="10.49" /></svg>
            </div>

            <div className="map-container">
              <iframe title="property-location" width="100%" height="100%" loading="lazy" allowFullScreen src={`https://www.google.com/maps/embed/v1/place?key=YOUR_API_KEY&q=${encodeURIComponent(trip.address)}`}></iframe>
            </div> 
            <Services />
