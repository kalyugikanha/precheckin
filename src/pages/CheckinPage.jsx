...
function CheckinPage() {
  ...
  const handleShareLink = () => {
   ...
   const handleCopyMapUrl = () => {
    // Create the Google Maps search URL from the address
  ...
  return (
    <div className="checkin-page-wrapper">
      ...
      <div className="checkin-page-layout">
        {/* --- Left Panel (YOUR Checkin Status Panel) --- */}
        <div className="checkin-status-panel">
          ...
          {/* --- THIS IS THE NEW, CORRECTED STRUCTURE FOR THE GRAPH --- */}
          ...
          <ul className="guest-list">
            {guests.map((guest, index) => ( // Added index for Guest #
              <li key={guest.id}>
...
>
  Check In
        ...
        {/* --- Right Panel (YOUR Property Details Panel) --- */}
        <div className="property-details-panel">
          ...
          <div className="property-info-box">
           ...
           <div className="info-list">
              ...
              <div className="info-item">
                <svg className="info-icon" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M21 12.79A9 9 0 1 1 11.21 3 7 7 0 0 0 21 12.79z"></path></svg>
    ...
    onClick={handleCopyMapUrl} // <-- ADD THIS LINE
